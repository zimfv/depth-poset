...
\begin{figure}[h!]
    ...
    \caption{The example of the filtration $f:\mtahbb{T}^2\to\mathbb{R}$, s.t. there are local minimums in the vertices, saddles in the middle of edges, and the localc maximums in the centers of square cells.}
    \label{fig:example2d}
\end{figure}
...
\par There are 289 experiments done. In the Figure \ref{fig:cases_distribution} we can see how cases are distributed by size and dimension.
\begin{figure}[ht]
  \centering
